 ...
 * TO DO This will change with future versions of AngularJS, to be removed when this happens
 *
...
uis.controller('uiSelectCtrl',
  ...
  ctrl.parseRepeatAttr = function(repeatAttr, groupByExp, groupFilterExp) {
    ...
    ctrl.refreshItems = function (data){
      ...
      //TO DO should implement for single mode removeSelected
      ...
      $select.searchInput.on('keydown', function(e) {
        ...
        scope.$apply(function() {
          ...
          if (processed  && key != KEY.TAB) {
            //TO DO Check si el tab selecciona aun correctamente
            //Crear test
            e.preventDefault();
            e.stopPropagation();
          }
