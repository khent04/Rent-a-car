# ferris errors always have a template
# this helper will convert the errors into message
...
CarERentalController = Controller
CarERentalController.dispatch = dispatch
